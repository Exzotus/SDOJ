...
client.commands = {}; // Initialize as an empty object
...
Object.keys(commands).forEach(commandName => {
  ...
  try {
      client.commands[commandName] = props; // Use plain object assignment
  } catch (error) {
...
client.on('messageCreate', message => {
  ...
  const command = client.commands[commandName]; // Access command from plain object
